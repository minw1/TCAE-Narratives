...
from narr_module import CT_Narrative_Data_Module
...
if __name__ == "__main__":
    ...
    parser.add_argument('--task', type=str, choices=['pieman'], default='pieman', help='Tasks for narrative data')
    ...
    parser.add_argument('--d_dec_latent', type=int, default=64, help='Dimension of decoder latent vector ')
    ...
    # Predictor Params
    parser.add_argument('--l_vocab', type=int, default=3, help='Vocab Length for POS prediction')
    ...
    parser.add_argument('--checkpoint_file', type=str, help='For POS prediction, the model will load this checkpoint of the autoencoder')
    ...
    data_module = CT_Narrative_Data_Module(task = args.task,
                                            task_tr = task_trs[args.task],
